                ...
                <motion.div key="login" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
                  <Form {...loginForm}>
                    <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-6">
                      ...
                      <button disabled={loading} className="w-full h-16 rounded-md bg-[#022717] text-white text-[11px] font-bold uppercase tracking-[0.3em] flex items-center justify-center gap-3 shadow-xl hover:bg-[#1a3d2b] transition-all disabled:opacity-50">
